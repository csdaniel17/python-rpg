...
import time
    ...
    # object is the root object that everything is supposed to inherit from
    # if something is on object anything you create will have it
    # object is most abstract concept

## Characters
class Character(object):
    # class Character has a method named alive that takes self
    def alive(self):
        return self.health > 0

    # class Character has a method named attack that takes self and enemy parameters
    ...
    # class Character has a method named receive_damage that takes self and points parameters
    ...
    # class Character has a method named print_status that takes self
...
class Hero(Character):
    ...
    # Making new method to add coins
    ...
    def do_battle(self, hero, enemy):
        ...
        while hero.alive() and enemy.alive():
            ...
            if input == 1:
                ...
                continue
            # check to see if hero has enough evade points to evade attack
...
hero = Hero()
enemies = [Goblin(), Wizard(), Medic(), Shadow(), Witch(), Chimera(), Zombie()]
